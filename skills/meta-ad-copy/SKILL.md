---
name: meta-ad-copy
description: Thin local adapter for Meta ad copy that layers workspace constraints on top of the installed ad-creative and paid-ads skills.
---
...
- Prefer the installed `ad-creative` frameworks such as angle-first generation, strong hooks, and spec validation.
- Use `paid-ads` logic when deciding whether the message should educate, qualify, or convert.
