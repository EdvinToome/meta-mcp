...
- Follow `AD_COPY_GUIDE.md` as the base guide and `~/.meta-mcp/BUSINESS_RULES.local.md` as the business-specific overlay when present.
...
- business-specific copy and localization rules -> edit `~/.meta-mcp/BUSINESS_RULES.local.md`
- site profile defaults -> edit `~/.meta-mcp/site-profiles.local.json`
