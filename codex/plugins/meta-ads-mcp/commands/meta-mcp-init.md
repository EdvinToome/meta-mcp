...
7. Remind the user that the `meta-ads-mcp` MCP server token is global and should be installed with the Meta MCP installer, not stored in this plugin bundle.
...
- The `meta-ads-mcp` MCP server for this plugin is configured globally.
