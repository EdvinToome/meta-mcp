...
2. Read:
   - `.claude/meta-marketing-plugin/brand_dna_copy.yaml` (or fallback `~/.meta-marketing-plugin/brand_dna_copy.yaml`)
   - `.claude/meta-marketing-plugin/brand_dna_visual.yaml` (or fallback `~/.meta-marketing-plugin/brand_dna_visual.yaml`)
   - `agents/claude/skills/gemini-creative-builder/assets/template-library/index.yaml`
   - chosen prompt file from `agents/claude/skills/gemini-creative-builder/assets/template-library/prompts/`
