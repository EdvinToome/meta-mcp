...
export function registerCreativeTools(
  ...
  server.tool(
    ...
    async (params) => createAdCreativeAction(metaClient, params)
  );
  ...
  server.tool(
    ...
    async (params) => uploadCreativeAssetAction(metaClient, params)
  );
    ...
    async ({
      ...
      try {
        ...
        if (instagram_user_id) {
          object_story_spec_preview.instagram_user_id = instagram_user_id;
        }
